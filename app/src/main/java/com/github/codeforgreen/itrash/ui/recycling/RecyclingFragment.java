...
import com.github.codeforgreen.itrash.databinding.FragmentRecyclingBinding;

public class RecyclingFragment extends Fragment {
    private RecyclingViewModel recyclingViewModel;
    private FragmentRecyclingBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = binding.textRecycling;
